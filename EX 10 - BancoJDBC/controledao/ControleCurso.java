...
//        resultadoConsulta.next();
    ...
    public List<Curso> getTodos() throws SQLException
    {
 ...
 public List<Curso> getPorIniciais() throws SQLException
    {
        String iniciais = "B";
        // lista contendo os cursos
        List<Curso> listaCursos = new ArrayList<>();
        ...
        // criar a string contendo o SQL
        String comandoSQL = "SELECT * FROM curso WHERE nome LIKE ?";
